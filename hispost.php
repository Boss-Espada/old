    ...
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="hispost.php" class="dropdown-item active">ประวัติงาน</a>
                        </div>
                    </div>
                    <?php
        ...
        <div class="content">
            ...
            $sql = "SELECT * FROM tab_jobmatch
                        JOIN tab_jobstatus
                        ON tab_jobstatus.status = 'งานสำเร็จแล้ว'
                        AND tab_jobmatch.employer_id = $user_id
                        JOIN tab_announce
                        ON tab_jobmatch.announce_id = tab_announce.announce_id
                        AND tab_announce.announce_id = tab_jobstatus.announce_id";
            try {
                                ...
                                <div class="modal-content bg-secondary">
                                    <div class="rounded p-3">
                                        ...
                                        <div class="rounded p-3 border border-primary">
                                            ...
                                            <div class="card-body text-center">
                                                <button class="alert alert-success">สถานะงาน : <?php echo htmlspecialchars($row['status']) ?></button>
                                            </div>
                                        </div>
