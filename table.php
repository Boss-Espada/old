        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="table.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>รับงาน</a>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-3 mt-3 text-center bg-secondary rounded p-3">
                    <form action="" method="post"><label for="form-check-label" class="form-check-label" style="margin-right:1% ;">ประเภทงาน</label>
                        <select class="rounded" name="category" aria-label="Default select example" style="padding: 1%; padding-right:15%; background: rgba(0, 0, 0, 0.6); color:white;">
                            <option selected value="reset">ทั้งหมด</option>
                            <option value="งานทั่วไป">งานทั่วไป</option>
                            <option value="งานไอที">งานไอที</option>
                            <option value="พิมพ์เอกสาร">พิมพ์เอกสาร</option>
                            <option value="อื่นๆ">อื่นๆ</option>
                        </select>
                        <button class="btn btn-primary display:inline;" name="filter">ค้นหา</button>
                    </form>
                </div>
            </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row">
                    ...
                    AND tab_jobstatus.status = 'หาผู้รับจ้าง'
                    JOIN tab_category
                        ...
                        <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="bg-secondary rounded h-100 p-4">
                                    <h6 class="mb-4">ไอดีงาน : <?php echo $row['work_id'] ?></h6>
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"><?php echo $row['price'] . " บาท" ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                ...
                                                <div class="card-footer" style="padding-bottom: 6%;">
                                                    <form action="db\db_get.php" method="post">
                                                        ...
                                                        <?php if (isset($_SESSION['student'])) { ?>
                                                            ...
                                                            } else { ?><button type="submit" class="btn btn-primary submitBtn mx-1" style="float:right;" name="submitget" value="ยืนยันรับงาน">ยืนยันรับงาน</button><?php } ?>
                                                        <?php } else {
                                                        } ?>
                                                        <button type="button" class="btn btn-light mx-1" style="float:right;" data-bs-dismiss="modal">ปิด</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                ...
                FROM tab_announce 
                JOIN tab_jobstatus 
                ON tab_jobstatus.status = 'หาผู้รับจ้าง' 
                JOIN tab_category
