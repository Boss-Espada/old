...
<body>
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>งานที่โพสต์จ้าง</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="statuspost.php" class="dropdown-item active">สถานะงาน</a>
        ...
        <div class="content">
            ...
            $sql = "SELECT tab_announce.announce_id,title,details,price,work_id,start_date,end_date,start_time,end_time,tab_announce.time_stamp,employer_name,employee_name,status,COUNT(*) 
                        FROM tab_jobmatch 
                        JOIN tab_announce
                        ON tab_jobmatch.employer_id = $user_id
                        AND tab_announce.user_id = $user_id
                        JOIN tab_jobstatus
                        ON tab_jobmatch.announce_id = tab_jobstatus.announce_id
                        AND tab_jobstatus.announce_id = tab_announce.announce_id
                        AND tab_jobstatus.status != 'งานสำเร็จแล้ว'
                        GROUP BY tab_announce.announce_id,title,details,price,work_id,start_date,end_date,start_time,end_time,time_stamp,employer_name,employee_name";
            try {
